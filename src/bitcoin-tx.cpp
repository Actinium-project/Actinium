...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " Actinium-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  Actinium-tx [options] <hex-tx> [commands]  Update hex-encoded actinium transaction\n" +
            "or:     Actinium-tx [options] -create [commands]   Create hex-encoded actinium transaction\n" +
            "\n";
