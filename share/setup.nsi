...
!else
InstallDir $PROGRAMFILES\Actinium
!endif
CRCCheck on
XPStyle on
BrandingText " "
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\Actinium-qt.exe
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Actinium Core (testnet, 64-bit).lnk" "$INSTDIR\Actinium-qt.exe" "-testnet" "$INSTDIR\Actinium-qt.exe" 1
    ...
    WriteRegStr HKCR "Actinium" "URL Protocol" ""
    WriteRegStr HKCR "Actinium" "" "URL:Actinium"
    WriteRegStr HKCR "Actinium\DefaultIcon" "" $INSTDIR\Actinium-qt.exe
    WriteRegStr HKCR "Actinium\shell\open\command" "" '"$INSTDIR\Actinium-qt.exe" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\Actinium-qt.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Actinium Core (testnet, 64-bit).lnk"
    Delete /REBOOTOK "$SMSTARTUP\Actinium.lnk"
