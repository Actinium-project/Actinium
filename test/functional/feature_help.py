...
"""Verify that starting actinium with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start actinium with -h for help text")
        ...
        self.log.info("Start actinium with -version for version information")
        ...
        self.log.info("Start Actiniumd with -fakearg to make sure it does not start")
