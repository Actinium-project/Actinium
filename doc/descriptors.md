# Support for Output Descriptors in Actinium Core

Since Actinium Core v0.17, there is support for Output Descriptors in the
...
existing Actinium Core wallets, a convenience function `combo` is
