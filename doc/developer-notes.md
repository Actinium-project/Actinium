...
- [Development guidelines](#development-guidelines)
    - [General Actinium Core](#general-actinium-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
file descriptors it will cause problems with Actinium's `select()` loop, because
...
would be to revert the upstream fix before applying the updates to Actinium's
